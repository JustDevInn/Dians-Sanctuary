...
const Savelives = () => {
  ...
  return (
    <div>
    {/* Hero banner */}
    <div className='text-black bg-savelivesdog1-img bg-cover bg-center'>
        <div className='max-w w-full h-screen mx-auto text-start flex flex-col justify-end bg-white bg-opacity-10 pb-10 pl-20 pr-20'>
            <p className='text-white w-4/5 md:w-3/5 font-bold bg-gray-600 bg-opacity-50 rounded-t pl-2 pt-2'>Save Lives With Us</p>
            ...
            <p className='md:text-2xl text-xl font-bold text-gray-300 py-2 rounded bg-gray-600 bg-opacity-50 w-4/5 md:w-3/5 pl-2'>Adopting a rescued animal is an act of <a href='/' class="underline decoration-[#00df9a]">kindness</a>.</p>
            <button className='bg-transparent text-white text-bold border-2 w-[200px] rounded-md font-medium my-3 py-3 hover:scale-110 duration-300'>Adopt</button>
        </div>
    </div>
...
<div className='w-full flex justify-center pt-20 pb-20'>
    <div className='text-black bg-adoptlinkimg-img bg-cover bg-center object-bottom w-4/5 rounded-md'>
        <div className='max-w w-full h-screen mx-auto text-start flex flex-col justify-end pl-10 bg-white bg-opacity-10 pb-10'>
            ...
            <button className='bg-transparent text-white text-bold border-2 w-[200px] rounded-md font-medium my-3 py-3 hover:scale-110 duration-300'><a href="https://www.instagram.com" target="_blank" rel="noreferrer">ADOPT NOW</a></button>
        </div>
    </div>
</div>
...
<div className='w-full flex justify-center pt-20 pb-20'>
    <div className=' bg-changecourseimg-img bg-cover object-bottom rounded-md bg-center'>
        <div className='max-w w-full h-screen mx-auto text-start flex flex-col justify-end bg-white bg-opacity-10 pb-10 pl-20 pr-20'>
            <p className='text-white w-4/5 md:w-3/5 bg-gray-600 bg-opacity-50 rounded-t pl-2 pt-2 font-thin'>Foster</p>
            <div className='flex flex-col justify-center bg-gray-600 bg-opacity-50 w-4/5 md:w-3/5 pl-2'>
...
<div className='w-full flex justify-center items-center pt-20 pb-20'>
    <div className='bg-puppycare-img bg-cover bg-right rounded-md box-content'>
        <div className=' w-full h-screen mx-auto text-start flex flex-col justify-center items-center bg-white bg-opacity-10 '>
            <p className=' text-white py-2 rounded-md text-left pt-10 pb-10 pl-5 pr-5 bg-gray-600 bg-opacity-50'>On average, animals undergoing rehabilitation in a shelter environment take several months to be fully healed and ready for adoption.
...
{/* Adopt & Foster form */}
<div name="contact" className="w-full flex justify-center bg-gradient-to-b from-black to-gray-800 p-4 text-white "  >
      <div className="flex flex-col lg:flex-row md:flex-row w-full pl-20 pr-20 pt-10 pb-10 justify-between items-center mx-auto m-0">
        <div className="pb-8">
