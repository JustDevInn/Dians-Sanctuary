...
const Change = () => {
  ...
  return (
    <div>
    {/* top hero text */}
  <div className='h-screen bg-gradient-to-b from-[#E7DFC6] to-[#E9F1F7] w-full py-5 text-gray-300 px-4 md:px-20 flex justify-center items-center'>
        <div className='max-w-[1240px] flex justify-center flex-col'>
        <h1 className='text-5xl md:text-6xl font-bold text-[#54426B] uppercase tracking-widest text-center mb-20'>Advocacy</h1>
            <div className='flex justify-center items-center pt-2 pb-10 '>
                <h3 className='md:text-4xl sm:text-3xl text-xl py-2 text-center text-[#54426B] tracking-wider'>"Rescuing animals from lives of suffering is a never-ending
...
{/* Chaining & Caging */}
<div className='w-full pb-10  bg-gradient-to-b from-[#E9F1F7] to-[#E7DFC6] tracking-wider'>
    <div className=' flex flex-col md:flex-row justify-center rounded'>
      
      <div className=' bg-cagingorchaining-img bg-cover bg-center md:w-full'>
        <div className='max-w w-full h-screen bg-white bg-opacity-10 px-4'></div>
      </div>
      <div className='flex justify-center items-center md:w-1/2 p-4'>
          <div className='flex flex-col justify-center'>
            <h1 className='font-thin text-4xl mb-5  uppercase text-[#54426B]'>Chaining & Caging</h1>
            <p className=' text-[#54426B]'>Many dog owners in Bali still adhere to the cruel practice of caging or chaining their pets, often without access to food, water or bedding, and at the mercy of heavy rains or blazing direct sunlight.</p>
          </div>
      </div>
    ...
    {/* Backyard breeders */}
<div className='w-full  py-10 bg-gradient-to-b from-[#E7DFC6] to-[#E9F1F7] tracking-wider'>
    <div className=' flex flex-col md:flex-row justify-center rounded'>
      
      <div className='flex justify-center items-center md:w-1/2 p-10'>
          <div className='flex flex-col justify-center'>
            <h1 className='font-thin text-4xl mb-5  uppercase text-[#54426B]'>Backyard breeders</h1>
            <p className=' text-[#54426B] '>The hidden realm of backyard breeders is one of the darkest parts of Balinese society, and with the demand for fashionable, designer, imported dog breeds on the rise, the atrocious suffering caused by this cruel industry continues unchecked.</p>
          </div>
      </div>

      <div className=' bg-backyardbreeders-img bg-cover bg-center md:w-1/2'>
        <div className='max-w w-full h-screen bg-white bg-opacity-10'></div>
      </div>
...
{/* Responsible tourism */}
<div className='w-full  py-10 bg-gradient-to-b from-[#E9F1F7] to-[#E7DFC6]'>
    <div className=' flex flex-col md:flex-row justify-center rounded'>
      ...
      <div className='flex justify-center items-center md:w-1/2 p-10'>
          <div className='flex flex-col justify-center'>
            <h1 className='font-thin text-4xl mb-5 tracking-wider uppercase text-[#54426B]'>Responsible tourism</h1>
...
{/* Donate */}
<div className='w-full h-screen flex justify-center items-center py-16 text-white md:pl-20 md:pr-20 bg-gradient-to-b from-[#E7DFC6] to-[#E9F1F7]'>
        <div className='max-w-[1240px] flex flex-col md:flex-row'>
          <div className='flex justify-center items-center md:w-1/2'>
            ...
            <div className='text-3xl md:w-1/2 pl-20 md:pl-0 text-[#54426B] font-thin'>
                <p className='text-4xl md:text-6xl'>It's not us saving their lives, 
                <br></br>
...
<div className='w-full py-10  bg-gradient-to-b from-[#E9F1F7] to-[#E7DFC6]'>
    <div className=' flex flex-col md:flex-row justify-center rounded'>
      ...
      <div className='flex justify-center items-center md:w-1/2 p-10'>
          <div className='flex flex-col justify-center'>
            <h1 className='font-thin text-4xl mb-5 tracking-wider uppercase text-[#54426B]'>Dog meat trade</h1>
...
{/* Rabies */}
  <div className='w-full py-10 bg-gradient-to-b from-[#E7DFC6] to-[#E9F1F7]'>
    <div className=' flex flex-col md:flex-row justify-center rounded'>
    ...
    <div className=' bg-rabies-img bg-cover bg-center md:w-1/2'> 
      ...
      <div className='flex justify-center items-center md:w-1/2 p-10'>
          <div className='flex flex-col justify-center'>
            <h1 className='font-thin text-4xl mb-5 tracking-wider uppercase text-[#54426B]'>Bali's rabies crisis</h1>
